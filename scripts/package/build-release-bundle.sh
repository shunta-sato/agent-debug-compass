...
cp -R "$ROOT_DIR/contracts" "$BUNDLE_DIR/contracts"
...
install -m 0755 "$ROOT_DIR/scripts/contract/validate-generated-contracts.sh" "$BUNDLE_DIR/scripts/contract/validate-generated-contracts.sh"
install -m 0755 "$ROOT_DIR/scripts/contract/normalize-generated-fixture.py" "$BUNDLE_DIR/scripts/contract/normalize-generated-fixture.py"
install -m 0755 "$ROOT_DIR/scripts/contract/check-coverage.py" "$BUNDLE_DIR/scripts/contract/check-coverage.py"
install -m 0644 "$ROOT_DIR/scripts/contract/requirements.txt" "$BUNDLE_DIR/scripts/contract/requirements.txt"
