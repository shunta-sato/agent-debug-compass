...
pub use recorder::{
    annotate_expected_signal_for_power_mode, collector_enabled_by_power_mode,
    default_recorder_budget, default_recorder_power_policy, drain_pending_recorder_markers,
    freeze_recorder_marker, freeze_recorder_marker_with_log_snapshot, freeze_recorder_trigger,
    freeze_recorder_trigger_with_decision, log_source_status_has_continuity,
    marker_at_received_time, read_recorder_status_artifact, recorder_budget_for_power_mode,
    recorder_default_budget_status, recorder_degradation_decisions_for_power_mode,
    recorder_expected_signal_for_id, recorder_expected_signals_for_collectors,
    recorder_freeze_decision_for_refused_trigger, recorder_incident_artifact_ref,
    recorder_incident_budget_status, recorder_marker_result_dir, recorder_marker_result_for_frozen,
    ...
    recorder_pending_marker_dir, recorder_pending_marker_ref, recorder_power_mode_for_snapshot,
    recorder_power_mode_override_from_env, recorder_power_snapshot_from_sysfs,
    recorder_resource_status_for_overhead, recorder_resource_status_for_service_run,
    ...
    recorder_trigger_decision_ref, unavailable_app_log_snapshot, validate_recorder_file_segment,
    write_pending_recorder_marker, write_recorder_marker_result, write_recorder_status_artifact,
    write_recorder_trigger_decision, AppendOnlyLogCursor, AssertedEventTime, CollectorLoss,
    ExpectedSamplesBasis, FrozenWindowPersistence, LossReport, PreservationReason,
    RecorderAdmissionDecision, RecorderAdmissionRefusalReason, RecorderBatteryState,
    RecorderBudget, RecorderBudgetStatus, RecorderBufferStatus, RecorderCoverageConfidence,
    RecorderCoverageState, RecorderDegradationAction, RecorderDegradationDecision,
    RecorderDegradationReason, RecorderExpectedSignal, RecorderFreeze, RecorderFreezeDecision,
    RecorderFreezeDecisionOutcome, RecorderFreezeDecisionSource, RecorderFrozenWindow,
    RecorderGapRange, RecorderIncident, RecorderIncidentCountScope, RecorderLayer,
    RecorderLogEvent, RecorderLogSnapshot, RecorderLogSourceStatus, RecorderMarker,
    RecorderMarkerResult, RecorderObservationCoverage, RecorderOverhead,
    RecorderOverheadAccounting, RecorderOverheadScope, RecorderPowerMode, RecorderPowerPolicy,
    RecorderPowerPolicyMode, RecorderPowerSnapshot, RecorderPowerSource, RecorderResourceRates,
    RecorderResourceScope, RecorderResourceStatus, RecorderRing, RecorderSample,
    RecorderSampleRateGovernor, RecorderSignalCoverage, RecorderSignalSample, RecorderSignalStatus,
    RecorderState, RecorderStatus, RecorderStatusInput, RecorderStatusWriteGovernor,
    RecorderStorageStatus, RecorderTimeRange, RecorderTriggerFreeze, RecorderTriggerFreezeRequest,
